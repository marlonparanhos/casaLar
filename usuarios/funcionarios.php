...
<body>
	...
	<section class="main container-fluid" id="loader">
		...
		<h1>Lista das funcionários cadastradas</h1>
		...
		$Funcionario = $Funcionario->ReadAll();
								...
								<table class="table table-hover table-striped">
									...
									<tbody>
										...
										foreach($Funcionario as $c){ ?>
											<tr>
												<td><?php echo $c['id'];?></td>
												<td><?php echo $c['nome_func'];?></td>
												<td><?php echo $c['cpf_func'];?></td>
												<td><?php echo $c['celular_func']; ?></td>
											</tr>
										<?php } ?>
									</tbody>
								</table>
