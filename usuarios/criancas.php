...
<body>
	...
	<section class="main container-fluid" id="loader">
		...
		<h1>Lista das crianças cadastradas</h1>
										...
										foreach($Crianca as $c){ ?>
											<tr>
												...
												<td class="text-center DetalhesItem">
													<a href="detalhes/detalhes.php?id=<?php echo $c['id'];?>&type=0" style="color: inherit;">
